...
class FinnominaService extends Component {
    
    public $fund_url_prefix = 'https://www.finnomena.com/fund';
    
    public function getFundDetail($fund_code){
        include('simple_html_dom.php');
        
        $path = $this->fund_url_prefix . '/' . $fund_code;
        
        $html = file_get_html($path);
        
        $nav_class = $html->find('.fund-nav-percent', 0);
        
        var_dump($nav_class->plaintext);exit();
