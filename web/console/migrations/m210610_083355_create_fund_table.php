...
class m210610_083355_create_fund_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%fund}}', [
            ...
            'frontend_fee' => $this->decimal(12,2)->notNull()->defaultValue(0)->comment('ค่าธรรมเนียมขาย'),
            'backend_fee' => $this->decimal(12,2)->notNull()->defaultValue(0)->comment('ค่าธรรมเนียมรับซื้อคืน'),
            'fee' => $this->decimal(12,2)->notNull()->defaultValue(0)->comment('ค่าธรรมเนียมจัดการ'),
