...
$this->registerCssFile(Yii::$app->assetManager->getPublishedUrl('@GpAsset')."/sign-modal/style.css", [
    'depends' => ['yii\bootstrap4\BootstrapAsset'],
]);
$this->registerCssFile(Yii::$app->assetManager->getPublishedUrl('@GpAsset')."/sign-modal/reset.css", [
    'depends' => ['yii\bootstrap4\BootstrapAsset'],
]);
$this->registerJsFile(Yii::$app->assetManager->getPublishedUrl('@GpAsset').'/sign-modal/modernizr.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->assetManager->getPublishedUrl('@GpAsset').'/sign-modal/main.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
		...
		<div class="cd-user-modal-container"> <!-- this is the container wrapper -->
			...
			<div id="cd-login"> <!-- log in form -->
				<form id="singin-form" class="cd-form">
					...
					<p class="fieldset text-center" id="signin-submit-block" load="<?= Yii::$app->assetManager->getPublishedUrl('@GpAsset') . "/sign-modal/img/please-wait.gif" ?>">
				...
				<form id="signup-form" class="cd-form">
                                            ...
                                            <?php echo Captcha::widget([
                                                ...
                                                'template' => '<div class="row">
                                                    ...
                                                    <div class="col-sm-1 no-padding">
                                                        <img id="img-captcha-refresh" title="Refresh image" src="'.Yii::$app->assetManager->getPublishedUrl('@GpAsset') . "/sign-modal/img/refresh.png".'" />
                                                    </div>
                                                    <div class="col-sm-8">
					...
					<p class="fieldset">
						...
						<label for="accept-terms">I agree to the <a class="rules-modal-button" href="#0">Terms</a></label>
                                        ...
                                        <p class="fieldset text-center" id="signup-submit-block" load="<?= Yii::$app->assetManager->getPublishedUrl('@GpAsset') . "/sign-modal/img/please-wait.gif" ?>">
			...
			<div id="cd-reset-password"> <!-- reset password form -->
				...
				<form id="resetpw" class="cd-form">
					...
					<p class="fieldset text-center" id="resetpw-submit-block">
			...
			<a href="#0" class="cd-close-form">Close</a>
                ...
                <div id="img-wait" class="hidden" load="<?= Yii::$app->assetManager->getPublishedUrl('@GpAsset') . "/sign-modal/img/please-wait.gif" ?>"></div>
	</div> <!-- cd-user-modal -->
